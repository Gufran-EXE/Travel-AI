  ...
  const socialLinks = [
    {
      ...
      url: 'https://github.com/Gufran-EXE',
    },
    {
      name: 'LinkedIn',
      icon: (
      ...
      url: 'https://www.linkedin.com/in/ansari-gufran-691409260/',
    },
    {
      name: 'Instagram',
      icon: (
      ...
      url: 'https://www.instagram.com/gufu_yt/',
    },
    {
      name: 'X (Twitter)',
      icon: (
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-center md:text-left">
            <p className="text-slate-400 text-sm mb-1">
              © {currentYear} <span className="font-semibold text-slate-300">VoyageAI</span> – AI Travel Planner
            </p>
